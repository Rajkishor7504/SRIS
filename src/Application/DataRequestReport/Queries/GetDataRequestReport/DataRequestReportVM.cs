...
{
    public class DataRequestReportVM
    {
        public DataRequestReportVM()
        {
            Lists = new List<DataRequestReportDto>();
        }

        //public DataRequestReportDto dataRequestReportDto { get; set; }
        public IList<DataRequestReportDto> Lists { get; set; }
