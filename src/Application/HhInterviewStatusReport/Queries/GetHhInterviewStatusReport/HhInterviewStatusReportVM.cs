...
{
    public class HhInterviewStatusReportVM
    {
        public HhInterviewStatusReportVM()
        {
            Lists = new List<HhInterviewStatusReportDto>();
        }

        public IList<HhInterviewStatusReportDto> Lists { get; set; }
