...
using SRIS.Application.Household.MobileApp.EduAndHealth.IncomeAgriImpactCoping;
...
namespace SRIS.Application.Household.MobileApp.IncomeAgriImpactCoping
{
  public  class RejectIncomeAgriImpactCoping : IRequest<IncomeAgriImpactCopingVM>
    {
    ...
    public class RejectIncomeAgriImpactCopingHandler : IRequestHandler<RejectIncomeAgriImpactCoping, IncomeAgriImpactCopingVM>
    {
        ...
        public RejectIncomeAgriImpactCopingHandler(IHouseholdService iHouseholdService, IHouseholdServiceMobile iHouseholdServiceMobile)
        {
            _iHouseholdService = iHouseholdService;
            _iHouseholdServiceMobile = iHouseholdServiceMobile;
        }

        public async Task<IncomeAgriImpactCopingVM> Handle(RejectIncomeAgriImpactCoping request, CancellationToken cancellationToken)
        {
                ...
                else
                {
                    ...
                    if (request.incomeSource != null)
                    {
                        ...
                        if (incomecnt > 0)
                        {
                            ...
                            entity.incomesourceid = Convert.ToInt32(request.incomeSource.incomeSourceId);//for update purpose
                    ...
                    {
                        int agricnt = await _iHouseholdServiceMobile.CheckRegisterHousehold("10", Convert.ToInt32(request.hhid), 0);//12 for copng
                        if (agricnt > 0)
                        {
                            ...
                            if (request.agriCultural.ecology.Count > 0)
                            {
                                foreach (var item in request.agriCultural.ecology)
                                {
                                    ecologystock.Add(new EcologyStock
                                    {
                                        ...
                                        ecologyName = Convert.ToString(item.ecologyName),
                                        eclid = Convert.ToInt32(item.eclid)
                                    });
                                }
                            }
                            ...
                            entity2.agricultureid = Convert.ToInt32(request.agriCultural.agricultureId); //for update purpose
                    ...
                    if (request.impactOfShock != null)
                    {
                        ...
                        if (impactcnt > 0)
                        {
                            ...
                            entity3.impactid = request.impactOfShock.impactId != "" ? Convert.ToInt32(request.impactOfShock.impactId) : 0; //for update purpose
                    ...
                    if (request.copingStrategies != null)
                    {
                        ...
                        if (copingcnt > 0)
                        {
                            ...
                            entity4.copingid = Convert.ToInt32(request.copingStrategies.copingId); //for update purpose
                    ...
                    #endregion
                    //if ((incomeretval == 200 || incomeretval==201) && (agricultureretval ==200 || agricultureretval==201) && (impactretval == 200 || impactretval == 201) && (copingretval == 200 || copingretval == 201))
                    if (request.copingStrategies != null
                    || request.impactOfShock != null
                    || request.agriCultural != null
                    || request.incomeSource != null)
                    {
                        int statuscnt = await _iHouseholdServiceMobile.CheckStatusOfHousehold("A", Convert.ToInt32(request.hhid), Convert.ToInt32(request.createdby));
