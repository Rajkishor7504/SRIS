...
{
   public class DemograpicConsolidateReportVM
    {
        public IList<DemograpicConsolidateReportDto> Lists { get; set; }
        public DemograpicConsolidateReportVM()
        {
            Lists = new List<DemograpicConsolidateReportDto>();
        }

        public IList<DemograpicConsolidateReportDto> ReportLists { get; set; }
