...
using SRIS.Domain.Entities.MisReport;
using System;
...
{
    public class EnumeratorWiseHhDataCollectionReportDto : IMapFrom<EnumeratorWiseHhDataCollectionReport>
    {
        public List<EnumeratorWiseHhDataCollectionReportDto> Lists { get; set; }
