...
{
    public class SettlementWiseTargetVM
    {
        public SettlementWiseTargetVM()
        {
            Lists = new List<SettlementWiseTargetDto>();
        }
    
        public IList<SettlementWiseTargetDto> Lists { get; set; }
