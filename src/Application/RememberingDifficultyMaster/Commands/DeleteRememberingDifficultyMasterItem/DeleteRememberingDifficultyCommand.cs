...
namespace SRIS.Application.RememberingDifficultyMaster.Commands.DeleteRememberingDifficultyMasterItem
{
  public class DeleteRememberingDifficultyCommand : IRequest<int>
    {
        public int id { get; set; }
    }
    public class DeleteRememberingDifficultyCommandHandler : IRequestHandler<DeleteRememberingDifficultyCommand, int>
    {
        private readonly IApplicationDbContext _context;

        public DeleteRememberingDifficultyCommandHandler(IApplicationDbContext context)
        {
            _context = context;
        }

        public async Task<int> Handle(DeleteRememberingDifficultyCommand request, CancellationToken cancellationToken)
        {
            int count = 0;
            int retval = 0;
