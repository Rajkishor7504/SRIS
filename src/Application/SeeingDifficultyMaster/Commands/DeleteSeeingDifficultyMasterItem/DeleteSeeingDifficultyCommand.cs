...
namespace SRIS.Application.SeeingDifficultyMaster.Commands.DeleteSeeingDifficultyMasterItem
{
    public class DeleteSeeingDifficultyCommand:IRequest<int>
    {
        public int id { get; set; }
    }
    public class DeleteSeeingDifficultyCommandHandler : IRequestHandler<DeleteSeeingDifficultyCommand,int>
    {
        private readonly IApplicationDbContext _context;

        public DeleteSeeingDifficultyCommandHandler(IApplicationDbContext context)
        {
            _context = context;
        }

        public async Task<int> Handle(DeleteSeeingDifficultyCommand request, CancellationToken cancellationToken)
        {
            int count = 0;
            int retval = 0;
