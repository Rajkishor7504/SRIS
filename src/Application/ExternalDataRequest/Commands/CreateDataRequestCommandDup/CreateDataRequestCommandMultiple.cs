...
namespace SRIS.Application.ExternalDataRequest.Commands.CreateDataRequestCommandDup
{
   public class CreateDataRequestCommandMultiple : IRequest<int>
    {
    ...
    public class CreateDataRequestCommandMultipleHandler : IRequestHandler<CreateDataRequestCommandMultiple, int>
    {
        private readonly IExternalDataRequestServiceDup _iExternalDataRequestService;

        public CreateDataRequestCommandMultipleHandler(IExternalDataRequestServiceDup iExternalDataRequestService)
        {
        ...
        public async Task<int> Handle(CreateDataRequestCommandMultiple request, CancellationToken cancellationToken)
        {
