...
{
    public class ExternalDataRequestVM : CommonMobileApiStatus
    {
        public ExternalDataRequestVM()
        {
            //Lists = new List<ExternalDataRequestDto>();
            p_Lists = new List<DuplicateExternalDto>();
        }
        ...
        public int download_s { get; set; }//status from t_datarequest table
       ...
       // public IList<ExternalDataRequestDto> Lists { get; set; }
        ...
        public IList<ExternalDataCriteriaDisplay> ExternalDataCriteriaLists { get; set; }
