...
{
   public class DataSharingOtherReportVM
    {
        public DataSharingOtherReportVM()
        {
            Lists = new List<DataSharingOtherReportDto>();
        }
        public IList<DataSharingOtherReportDto> Lists { get; set; }
        ...
        public int drinkingWaterDistance { get; set; }
        public int dispensaryDistance { get; set; }
